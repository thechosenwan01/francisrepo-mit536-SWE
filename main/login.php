...
<script>
    // Function to validate the data and redirect or show an alert
    function checkData() {
        var password = "admin";
    ...
    // Add an event listener to trigger checkData() when Enter key is pressed
    document.addEventListener('DOMContentLoaded', function () {
        document.getElementById('admin_pass').addEventListener('keydown', function (event) {
            if (event.key === "Enter") {
                checkData();
            }
        });
