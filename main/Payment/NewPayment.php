   ...
   <head>
      ...
      <script>
        ...
        function checkRadio(radio)
        {
            ...
            {
               document.getElementById("hsnc").innerHTML = "<div class='row col-md-6' style='margin-bottom: 20px;'><input type='number' name='ChallanNo' class='form-control col-md-4' id='name' placeholder='Enter Document Number'></div>";
            }
                        ...
                        <div class="form-group col-md-12">
                           ...
                           <div class="form-check form-check-inline">
                            ...
                            <div class="form-check form-check-inline">
                              ...
                              <label class="form-check-label" for="inlineRadio3" name="challan">Document Number</label>
                           </div>
                           <div class="form-check form-check-inline">
