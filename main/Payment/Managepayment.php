   ...
   <script>
      function checkRadio(radio) {
         if (radio.id === "customerName") {
            ...
            document.getElementById("hsnc").innerHTML = "<input type='number' name='challanno' style='margin-bottom: 20px;' class='form-control col-md-4' id='name' placeholder='Enter Document Number'>";
         }
                     ...
                     <div class="form-group col-md-8" >
                        ...
                        <div class="form-check form-check-inline">
                           <input class="form-check-input" type="radio" name="mc" id="challanno" value="challanno"
                              onchange="checkRadio(this)">
                           <label class="form-check-label" for="inlineRadio4" name="challan">Document Number</label>
                        </div>
                        <div class="form-check form-check-inline">
