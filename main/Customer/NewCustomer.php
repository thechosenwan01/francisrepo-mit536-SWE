                  ...
                  <div class="card-body">
                     <form class="" action="NewCustomer.php" method="post">
                        ...
                        <div class="form-group col-md-6">
                           ...
                           <input type="text" name="cmno" class="form-control" id="cmno" pattern="[0-9]{10}" maxlength="10" placeholder="09XXXXXXXX" required="" title="Only Contains Numbers"> 
                        </div>

                        <div class="form-group col-md-6">
                           <label class="form-label">GST No.: </label>
                           <input type="text" name="cgst" class="form-control" id="cgst" required="" pattern = "^\d{4,15}$" maxlength="15" placeholder="Enter GST Number"> 
                        </div>
